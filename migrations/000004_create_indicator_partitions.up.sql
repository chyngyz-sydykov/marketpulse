...
CREATE TABLE IF NOT EXISTS indicator_btc_1w PARTITION OF indicator_btc FOR VALUES IN ('1w');
CREATE TABLE IF NOT EXISTS indicator_btc_1m PARTITION OF indicator_btc FOR VALUES IN ('1m');
...
CREATE TABLE IF NOT EXISTS indicator_eth_1w PARTITION OF indicator_eth FOR VALUES IN ('1w');
CREATE TABLE IF NOT EXISTS indicator_eth_1m PARTITION OF indicator_eth FOR VALUES IN ('1m');
...
CREATE TABLE IF NOT EXISTS indicator_sol_1w PARTITION OF indicator_sol FOR VALUES IN ('1w');
CREATE TABLE IF NOT EXISTS indicator_sol_1m PARTITION OF indicator_sol FOR VALUES IN ('1m');
...
CREATE TABLE IF NOT EXISTS indicator_bnb_1w PARTITION OF indicator_bnb FOR VALUES IN ('1w');
CREATE TABLE IF NOT EXISTS indicator_bnb_1m PARTITION OF indicator_bnb FOR VALUES IN ('1m');
...
CREATE TABLE IF NOT EXISTS indicator_trump_1w PARTITION OF indicator_trump FOR VALUES IN ('1w');
CREATE TABLE IF NOT EXISTS indicator_trump_1m PARTITION OF indicator_trump FOR VALUES IN ('1m');
